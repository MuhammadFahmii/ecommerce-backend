...
namespace netca.Application.Common.Extensions
{
    ...
    public static class DateExtensions
    {
        ...
        {
            DateTime result;
            return DateTime.TryParseExact(date, format, CultureInfo.CurrentCulture, DateTimeStyles.None, out result);
        }
        ...
        /// <returns></returns>
        public static DateTime? FormatDate(string date, string formatDate, DateTime defaultDate, int addHour)
        {
        ...
        /// <param name="addHour"></param>
        /// <returns></returns>
        public static DateTime? FormatDate(string date, string formatDate, string time, string formatTime, int addHour)
        {
