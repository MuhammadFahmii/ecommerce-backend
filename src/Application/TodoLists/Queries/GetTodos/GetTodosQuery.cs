...
public class GetTodosQueryHandler : IRequestHandler<GetTodosQuery, DocumentRootJson<List<TodoListVm>>>
{
    ...
    /// <returns></returns>
    public async Task<DocumentRootJson<List<TodoListVm>>> Handle(GetTodosQuery request,
        CancellationToken cancellationToken)
    {
        ...
        return JsonApiExtensions.ToJsonApiPaginated(data, meta, countEntity,
            request.PageNumber ?? Constants.DefaultPageNumber, request.PageSize ?? Constants.DefaultPageSize);
    }
}